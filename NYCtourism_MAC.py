...
# call back function onclick of attraction websie URL
def open_url(event):
...
# call listIndexes for each category list
...
def filterResults(canvasFrame):
    ...
    if len(selectedTimes) > 0:
        for time in selectedTimes:
            ...
            resultDataFrame = timeDataFrame.append(results)
    ...
    # If the final data frame made with all desired filters is empty, 
...
def createAttractionTab(): #function for tab to click on for attractions
    ...
    label = Label(frame2, text='TYPE OF ATTRACTION', bg = "#c9e4ff", font = "Arial 17 bold")
    label.configure(foreground="Navy")
    label.place(relx=0, rely=0.075)
    check_Sightseeing = tkinter.Checkbutton(frame2, text = 'Sightseeing', font = "Arial, 15", bg = "#c9e4ff", variable = attractionListIndexed[0],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.12)

    check_Landmark = tkinter.Checkbutton(frame2, text = 'Landmark', font = "Arial, 15", bg = "#c9e4ff", variable = attractionListIndexed[1],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.165)

    check_Parks = tkinter.Checkbutton(frame2, text = 'Parks', font = "Arial, 15", bg = "#c9e4ff", variable = attractionListIndexed[2],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.21)

    check_Entertainment= tkinter.Checkbutton(frame2, text = 'Entertainment', font = "Arial, 15", bg = "#c9e4ff", variable = attractionListIndexed[3],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.255)

    check_Nature= tkinter.Checkbutton(frame2, text = 'Nature', font = "Arial, 15", bg = "#c9e4ff", variable = attractionListIndexed[4],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.30)

    check_Shopping= tkinter.Checkbutton(frame2, text = 'Shopping', font = "Arial, 15", bg = "#c9e4ff", variable = attractionListIndexed[5],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.345)

    check_Restaurant= tkinter.Checkbutton(frame2, text = 'Restaurant', font = "Arial, 15", bg = "#c9e4ff", variable = attractionListIndexed[6],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.39)

    check_AquaandZoos= tkinter.Checkbutton(frame2, text = 'Aquariums and Zoos', font = "Arial, 15", bg = "#c9e4ff", variable = attractionListIndexed[7],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.435)

    check_Museums= tkinter.Checkbutton(frame2, text = 'Museums', font = "Arial, 15", bg = "#c9e4ff", variable = attractionListIndexed[8],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.48)

    check_Beaches= tkinter.Checkbutton(frame2, text = 'Beaches', font = "Arial, 15", bg = "#c9e4ff", variable = attractionListIndexed[9],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.525)


    label = Label(frame2, text='TARGET AUDIENCE', bg = "#c9e4ff", font = "Arial 17 bold")
    label.configure(foreground="Navy")
    label.place(relx=0, rely=0.615)
    check_Good4Kids= tkinter.Checkbutton(frame2, text = 'Good For Kids', font = "Arial, 15", bg = "#c9e4ff", variable = audienceListIndexed[0],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.66)

    check_Good4BigGroups= tkinter.Checkbutton(frame2, text = 'Good for Big Groups', font = "Arial, 15", bg = "#c9e4ff", variable = audienceListIndexed[1],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.705)

    check_Good4Couples= tkinter.Checkbutton(frame2, text = 'Good for Couples', font = "Arial, 15", bg = "#c9e4ff", variable = audienceListIndexed[2],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.75)

    check_Good4RainyDay= tkinter.Checkbutton(frame2, text = 'Good for Rainy Day', font = "Arial, 15", bg = "#c9e4ff", variable = audienceListIndexed[3],
            onvalue = 1, offvalue = 0).place(relx=0, rely=0.795)


    label = Label(frame2, text='LOCATION', bg = "#c9e4ff", font = "Arial 17 bold")
    label.configure(foreground="Navy")
    label.place(relx=0.5, rely=0.075)
    check_Manhattan = tkinter.Checkbutton(frame2, text = "Manhattan", font = "Arial, 15", bg = "#c9e4ff", variable = locationListIndexed[0],
            onvalue = 1, offvalue = 0).place(relx=0.5, rely=0.12)
    
    check_Bronx = tkinter.Checkbutton(frame2, text = "Bronx", font = "Arial, 15", bg = "#c9e4ff", variable = locationListIndexed[1],
            onvalue = 1, offvalue = 0).place(relx=0.5, rely=0.165)

    check_Statisland = tkinter.Checkbutton(frame2, text = "Staten Island", font = "Arial, 15", bg = "#c9e4ff", variable = locationListIndexed[2],
            onvalue = 1, offvalue = 0).place(relx=0.5, rely=0.21)

    check_LongIsland = tkinter.Checkbutton(frame2, text = "Long Island", font = "Arial, 15", bg = "#c9e4ff", variable = locationListIndexed[4],
            onvalue = 1, offvalue = 0).place(relx=0.5, rely=0.255)

    check_Brooklyn = tkinter.Checkbutton(frame2, text = "Brooklyn", font = "Arial, 15", bg = "#c9e4ff", variable = locationListIndexed[5],
    onvalue = 1, offvalue = 0).place(relx=0.5, rely=0.3)

    check_Queens = tkinter.Checkbutton(frame2, text = "Queens", font = "Arial, 15", bg = "#c9e4ff", variable = locationListIndexed[6],
    onvalue = 1, offvalue = 0).place(relx=0.5, rely=0.345)

    label = Label(frame2, text='FREE', bg = "#c9e4ff", font = "Arial 17 bold")
    label.configure(foreground="Navy")
    label.place(relx=0.5, rely=0.435)
    check_Free = tkinter.Checkbutton(frame2, text = "Free", font = "Arial, 15", bg = "#c9e4ff", variable = isFree, 
    onvalue = True, offvalue= False).place(relx=0.5, rely=0.48)

    label = Label(frame2, text='TIME', bg = "#c9e4ff", font = "Arial 17 bold")
    label.configure(foreground="Navy")
    label.place(relx=0.5, rely=0.58)
    check_FullDay = tkinter.Checkbutton(frame2, text = "Full Day", font = "Arial, 15", bg = "#c9e4ff", variable = timeListIndexed[0],
    onvalue = 1, offvalue = 0).place(relx=0.5, rely=0.625)

    check_Half2FullDay = tkinter.Checkbutton(frame2, text = "Half Day to Full Day", font = "Arial, 15", bg = "#c9e4ff", variable = timeListIndexed[1],
    onvalue = 1, offvalue = 0).place(relx=0.5, rely=0.67)

    check_2plus = tkinter.Checkbutton(frame2, text = "2+ Hours", font = "Arial, 15", bg = "#c9e4ff", variable = timeListIndexed[2],
    onvalue = 1, offvalue = 0).place(relx=0.5, rely=0.715)

    check_1plus = tkinter.Checkbutton(frame2, text = "1+ Hours", font = "Arial, 15", bg = "#c9e4ff", variable = timeListIndexed[3],
    onvalue = 1, offvalue = 0).place(relx=0.5, rely=0.76)
...
#This function creates the goes back to the default home tab
def createHomeTab():
    tab()
...
def tab():
    ...
    homeButton = tk.Button(frame, text = "HOME", fg="navy", font="Arial 30 bold", highlightthickness=5, highlightbackground="#c9e4ff", command=createHomeTab)
    homeButton.place(relx=0, rely=0.5, relheight=0.6, relwidth=0.5, anchor="nw")

    attractionButton = tk.Button(frame, text = "FIND ATTRACTIONS", fg="navy", font="Arial 30 bold", highlightthickness=5, highlightbackground="#c9e4ff", command=createAttractionTab)
    attractionButton.place(relx=0.5, rely=0.5, relheight=0.6, relwidth=0.5, anchor="nw")
